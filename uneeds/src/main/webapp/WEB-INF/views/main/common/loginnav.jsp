...
<div class="logitem">
	...
	<!-- login div -->
	<div class="loginDiv px-auto py-auto mx-auto my-3">
		<!-- 구글 -->
		<div class="g-signin2 mx-auto my-auto px-auto py-auto" data-onsuccess="onSignIn" data-theme="dark"></div>
